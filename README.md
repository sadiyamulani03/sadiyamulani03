...
[![Email](https://img.shields.io/badge/-Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:sadiyamulani03@gmail.com)
...
- 🔗 **Blockchain & Web3 enthusiast** — building on Stellar (Soroban), exploring Midnight (ZK), learning DeFi
- 🎨 **Frontend & UI** — cyberpunk/neon aesthetics, vanilla JS animations, particle systems, 3D effects
- 🔐 **Applied Cryptography** — AES-256, RSA, SHA-256, hybrid encryption, digital signatures, blockchain integrity
- 🐍 **Python & Data** — desktop apps (Tkinter), MySQL/SQLite, Matplotlib analytics, socket networking
- 📖 **Documenting my journey** — from first wallet to production smart contracts, all in public
...
![Soroban](https://img.shields.io/badge/Soroban-Rust-6C63FF?style=flat-square)
![Midnight](https://img.shields.io/badge/Midnight-ZK/Privacy-1a1a2e?style=flat-square&logoColor=9D50FF)
![Solidity](https://img.shields.io/badge/Solidity-363636?style=flat-square&logo=solidity&logoColor=white)
![OpenZeppelin](https://img.shields.io/badge/OpenZeppelin-Contracts-363636?style=flat-square)
...
![Zustand](https://img.shields.io/badge/Zustand-State-000?style=flat-square)
![React_Query](https://img.shields.io/badge/React_Query-FF4154?style=flat-square&logo=reactquery&logoColor=white)
...
| Area | Status | Details |
|------|--------|---------|
| **Soroban Smart Contracts** | 🟢 Active | Production-grade escrow, loyalty tokens, upgradeable contracts |
| **Midnight (ZK/Privacy)** | 🟡 Learning | Private smart contracts, zero-knowledge proofs |
| **DeFi Primitives** | 🟡 Learning | AMMs, lending, staking on Stellar |
| **Road to DevCon** | 🔴 In Progress | Building portfolio projects, networking |
| **Web3 Internships** | 🔴 Seeking | Open to opportunities — let's connect! |
